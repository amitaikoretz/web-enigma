...
def _command_line(parts: list[str]) -> str:
    return format_terminal_command(parts)


def _base_spec(command_line: str, *, entrypoint: str) -> dict[str, Any]:
