...
describe('DatasetsListPage', () => {
  ...
  it('shows a single symbol for one-symbol datasets and a count for multi-symbol datasets', async () => {
    fetchDatasetsMock.mockResolvedValue({
      items: [
        {
          id: 'ds-1',
        ...
        },
        {
          ...
          params_json: {},
          output_dir: '/tmp/datasets',
          dataset_parquet_path: '/tmp/datasets/basket.parquet',
          manifest_path: '/tmp/datasets/basket.manifest.json',
          error_message: null,
          progress_pct: 100,
        },
      ],
    ...
    expect(screen.getByRole('cell', { name: '3 symbols' })).toBeInTheDocument()
  })
